...
CREATE CONTINUOUS QUERY "trade_to_cq_1m" ON api_production
...
END;
CREATE CONTINUOUS QUERY "candles_1m_to_cq_1m" ON api_production
...
END;
CREATE CONTINUOUS QUERY "cq_5m" ON api_production
...
END;
CREATE CONTINUOUS QUERY "cq_15m" ON api_production
...
END;
CREATE CONTINUOUS QUERY "cq_30m" ON api_production
...
END;
CREATE CONTINUOUS QUERY "cq_1h" ON api_production
...
END;
CREATE CONTINUOUS QUERY "cq_2h" ON api_production
...
END;
CREATE CONTINUOUS QUERY "cq_4h" ON api_production
...
END;
CREATE CONTINUOUS QUERY "cq_6h" ON api_production
...
END;
CREATE CONTINUOUS QUERY "cq_12h" ON api_production
...
END;
CREATE CONTINUOUS QUERY "cq_1d" ON api_production
...
END;
CREATE CONTINUOUS QUERY "cq_3d" ON api_production
...
END;
CREATE CONTINUOUS QUERY "cq_1w" ON api_production
